...
public class DebuggingTaskOutputCachingBuildCacheKeyBuilder implements TaskOutputCachingBuildCacheKeyBuilder {
    ...
    public void appendInputValuePropertyHash(String propertyName, HashCode hashCode) {
        LOGGER.lifecycle("Appending appendInputValuePropertyHash for '{}' to build cache key: {}", propertyName, hashCode);
    ...
    public void appendInputFilesProperty(String propertyName, FileCollectionSnapshot fileCollectionSnapshot) {
        LOGGER.lifecycle("Appending appendInputFilesProperty for '{}' to build cache key: {}", propertyName, fileCollectionSnapshot.getHash());
